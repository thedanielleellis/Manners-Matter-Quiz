...
Installation
1. Clone this repo to you local drive by running `git clone https://github.com/thedanielleellis/Manners-Matter-Quiz/tree/MannersMatter2, then cd into the cloned folder.
